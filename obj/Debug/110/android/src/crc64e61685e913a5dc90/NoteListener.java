...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("WhatNote.EventListeners.NoteListener, WhatNote", NoteListener.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == NoteListener.class)
			mono.android.TypeManager.Activate ("WhatNote.EventListeners.NoteListener, WhatNote", "", this, new java.lang.Object[] {  });
	}
